    ...
    <div class="top-panel d-block d-md-flex align-items-center justify-content-between">
      <div class="logo text-center">
        ...
        <a href="{{url('restaurant') }}">
          <img src="{{site_setting('restaurant_logo','3')}}">
        </a>
        @else
        <a href="{{url('home') }}">
      ...
      <div class="flex-grow-1 header-search d-flex align-items-center justify-content-center">
        ...
        <form class="d-none d-md-none d-lg-block m-0">
          ...
          <span class="d-none text-danger location_error_msg">Enter your delivery address to see if this restaurant is available in your area </span>
        </form>
      </div>
      @endif
      <div class="main-menu">
        <nav class="navbar navbar-expand-md px-0">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto" ng-controller="restaurant_side_bar">
              ...
              <li class="nav-item">
                <a class="nav-link btn btn-primary" href="{{route('restaurant.login')}}">{{trans('messages.profile.sign_in')}}</a>
              </li>
              ...
              <li class="nav-item">
                <label class="switch">
                  <input type="checkbox" id="restaurant_status_toogle" class="status_check" {{get_restaurant_user_id(get_current_restaurant_id(),'status')=='1'?"checked=checked":''}}>
                  <div class="toggle-slider round">
                    <span class="restaurant_status_avai {{get_restaurant_user_id(get_current_restaurant_id(),'status')=='1'?'':'d-none'}}">
                      {{ trans('admin_messages.available') }}
                    </span>
                    <span class="restaurant_status_unavai {{get_restaurant_user_id(get_current_restaurant_id(),'status')=='1'?'d-none':''}}">
              ...
              @if(is_user() || !Route::current()->named("restaurant.*"))
              <li class="nav-item">
                <a class="nav-link btn btn-secondary" href="{{route('signup')}}" name="signup">Register</a>
              </li>
              @endif
