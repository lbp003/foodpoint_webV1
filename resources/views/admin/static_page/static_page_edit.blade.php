                ...
                <div class="row">
                  ...
                  <div class="col-sm-6">
                    ...
                    <div class="row">
                     ...
                     <div class="row">
                        ...
                        <div class="col-sm-10">
                          ...
                          <textarea id="content" name="content" hidden="true">{{  @$static_page->content }}</textarea>
                    ...
                    <div class="row">
                     ...
                     <div class="panel" ng-init="translations = {{json_encode(old('translations') ?: @$static_page->translations)}}; removed_translations =  []; errors = {{json_encode($errors->getMessages())}}; result_translations = {{json_encode(@$static_page->translations)}}">
