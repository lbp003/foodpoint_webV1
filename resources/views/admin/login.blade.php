...
<body class="off-canvas-sidebar login-page">
    ...
    <div class="wrapper wrapper-full-page">
        <div class="page-header login-page header-filter" filter-color="black" style="background-image: url('{{asset('admin_assets/img/login.jpg')}}'); background-size: cover; background-position: top center;">
                        ...
                        <div class="card-body">
                            ...
                            <span class="bmd-form-group">
                                <div class="input-group">
                                    ...
                                    <div class="input-field flex-grow-1">
                                        {!! Form::text('user_name',$email,['class'=>'form-control mt-0','placeholder'=>'User Name'])  !!}
                            ...
                            <span class="bmd-form-group">
                                <div class="input-group mt-2">
                                    ...
                                    <div class="input-field flex-grow-1">
                                    {!! Form::input('password','password',$password,['class'=>'form-control mt-0','placeholder'=>'password']) !!}
