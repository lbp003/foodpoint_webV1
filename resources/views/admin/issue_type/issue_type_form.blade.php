                ...
                {!! Form::open(['url' => $form_action, 'class' => 'form-horizontal','id'=>'issue_form']) !!}
                  @csrf
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                        {!! Form::text('issue',@$issue_type->name, ['class' => 'form-control','size'=>'3x3', 'id' => 'input_reason','placeholder' => 'Issue']) !!}
                  ...
                  <div class="panel-body">
                    ...
                    <h4 class="box-title text-center">Translations</h4>
                     ...
                     <div class="row" >
                      ...
                      <div class="row">
                      <label for="input_name_@{{$index}}" class="col-sm-2 col-form-label">@lang('admin_messages.issue')<span class="required text-danger">*</span></label>
                      <div class="col-sm-6">
                        <div class="form-group">
                        {!! Form::text('translations[@{{$index}}][name]', '@{{translation.name}}', ['class' => 'form-control', 'id' => 'input_name_@{{$index}}', 'placeholder' => 'Issue']) !!}
