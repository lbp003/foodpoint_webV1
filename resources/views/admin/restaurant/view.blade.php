	...
	<div class="container-fluid">
     ...
     <div style="float: right;text-align: right;" class="col-md-12">
      @checkPermission('create-restaurant')
				<a class="btn btn-success" href="{{route('admin.add_restaurant')}}" > @lang('admin_messages.add_restaurant') </a>
        @endcheckPermission
			</div>
      <div class="card-body ">
...
<script>
  var oTable = $('#statement_table').DataTable({
    ...
    {data: 'restaurant_name',name: 'restaurant_name',title: 'Restaurant Name'},
    {data: 'email',name: 'email',title: 'Email'},
    {data: 'user_status',name: 'user_status',title: 'User Status'},
    {data: 'restaurant_status',name: 'restaurant_status',title: 'Restaurant Status'},
    {data: 'app_delivery_mode_text',name: 'app_delivery_mode_text',title: 'Delivery Type'},
