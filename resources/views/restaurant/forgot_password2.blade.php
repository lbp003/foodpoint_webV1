		...
		<div class="login-form py-5 mb-5 col-md-8 col-lg-6 mx-auto">
			...
			<form name="forgotpassword2" method="POST" action="{{route('restaurant.set_password')}}">
				...
				<div class="form-group">
					...
					<label>{{trans('messages.restaurant_dashboard.enter_digit_code_sent_to_your_email')}}</label>
				...
				<button class="btn btn-theme w-100 mt-3 d-flex justify-content-between align-items-center" id="code_confirm_submit" type="submit">{{trans('messages.restaurant_dashboard.next')}} <i class="icon icon-right-arrow"></i></button>
			</form>
		</div>
	</div>
</main>
