	...
	<div class="partners offers-page py-5 px-0" >
		...
		<div class="container" ng-init="offers={{ $offer }};offer_index='';offer_id='';edit_offer=''">
			<div class="my-4 d-flex justify-content-between align-items-center">
				<h1 class="title">{{trans('messages.restaurant_dashboard.offers')}}</h1>
			...
			<div class="offers-table my-4">
				<div class="table-responsive">
					<table>
						<thead>
							<tr>
								<th>{{trans('messages.restaurant_dashboard.id')}}</th>
								<th>{{trans('messages.restaurant_dashboard.Offer_title')}}</th>
								...
								<th>{{trans('messages.restaurant_dashboard.actions')}}</th>
							</tr>
						</thead>
						<tbody>
							...
							<tr ng-hide="offers.length>0"><td colspan="7">{{trans('messages.restaurant_dashboard.no_offers')}}</td> </tr>
						</tbody>
					</table>
				</div>
			</div>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h3 class="modal-title">{{trans('messages.restaurant_dashboard.delete_this_offer')}}</h3>
				</div>
				<div class="modal-body">
					<p>{{trans('messages.restaurant_dashboard.this_will_delete_offer_action_cannot_be_undone')}}</p>
					<p class="text-danger delete_item_msg"> </p>
				</div>
				<div class="modal-footer text-right">
					<button type="reset" data-dismiss="modal" class="offer_cancel_button btn btn-primary theme-color">{{trans('messages.restaurant.cancel')}}</button>
					<button type="submit" class="btn btn-theme ml-2" data-dismiss="modal" ng-click="delete_offer()">{{trans('messages.restaurant.submit')}}</button>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h5 class="my-3 modal-title text-capitalize text-center" ng-if="offer_title=='Edit offer'">{{trans('admin_messages.edit_restaurant_offer')}}</h5>
				...
				<div class="modal-body offer_form_div">
					<form id="offer_form">
						<div class="form-group d-md-flex">
							<div class="col-md-4">
								<label>
									{{trans('messages.restaurant_dashboard.Offer_title')}}
						...
						<div class="form-group d-md-flex">
							<div class="col-md-4">
								<label>
									{{trans('messages.restaurant_dashboard.offer_description')}}
									<span class="required">*</span>
								</label>
							</div>
							<div class="col-md-8">
						...
						<div class="mt-3 pt-4 modal-footer px-0 text-right">
							<button data-dismiss="modal" type="cancel" class="btn btn-primary theme-color">{{trans('messages.restaurant.cancel')}}</button>
							<button type="submit" class="btn btn-theme ml-2" ng-click="add_offer()">{{trans('messages.restaurant.submit')}}</button>
						</div>
					</form>
				</div>
			</div>
