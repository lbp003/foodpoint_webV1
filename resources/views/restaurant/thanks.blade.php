			...
			<div class="container">
				<div class="row">
					<div class="col-md-4">
						...
						<p>{{site_setting('site_name')}} makes a real impact on your business. When your food is featured in the app, new customers can discover it and loyal customers can enjoy it more often. We’ve seen restaurants increase sales, lower marketing costs, and hire new employees to capitalize on {{site_setting('site_name')}} demand.</p>
					</div>
					<div class="col-md-4">
						<div class="res-img">
