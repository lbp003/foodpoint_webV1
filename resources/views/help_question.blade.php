				...
				<div class="d-md-flex">
					<div class="help-nav col-md-4 col-lg-3 pl-0">
						<ul>
							...
							<li>
								<a class="help_nav_link {{$help_category->id==$question->subcategory_id?'active':''}}"  href="{{route('help_subcategory',['page'=>$page,'category_id'=>$help_category->category_id,'subcategory_id'=>$help_category->id])}}">
					...
					<div class="help-faq col-md-8 col-lg-9 p-0">
						<div class="breadcrumb">
							<ul>
								...
								<li>
									<a href="{{route('help_category',['page'=>$page,'category_id'=>$question->category->id])}}">
										 {{$question->category->category_name_lang}}
									</a>
									<i class="icon icon-angle-arrow-pointing-to-right-1 mx-2"></i>
								</li>
								<li>
									<a href="{{route('help_subcategory',['page'=>$page,'category_id'=>$question->category_id,'subcategory_id'=>$question->subcategory_id])}}">
												
										 {{$question->subcategory->name_lang}}
									</a>
									<i class="icon icon-angle-arrow-pointing-to-right-1 mx-2"></i>
								</li>
							</ul>
