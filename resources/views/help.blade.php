...
<main id="site-content" role="main" ng-controller="help">
	<div class="help-page">
		<div class="help-top d-flex">
         ...
         @if($page=='eater')
				<div class="help-banner {{$page=='eater'?'active':''}}" help-attr="eaters" style="background-image: url({{url('/')}}/images/banner3.jpg);" >
				...
				<div class="help-banner {{$page=='restaurant'?'active':''}}" help-attr="restaurants" style="background-image: url({{url('/')}}/images/default-restaurant.jpg);">
					<div class="container d-flex h-100">
						<div class="banner-content my-auto">
							<h1>
								{{trans('messages.profile.having_trouble')}}?
			...
			<div class="container">
				<div class="d-md-flex">
					<div class="help-nav col-md-4 col-lg-3 pl-0">
						<ul>
							<li>
								<a class="help_nav_link {{$page=='eater'?'active':''}}" href="{{route('help_page','eater')}}" help-attr="eaters">
									{{trans('messages.help.for_eaters')}}
								</a>
							</li>
							<li>
							...
							<li>
								<a class="help_nav_link {{$page=='restaurant'?'active':''}}" href="{{route('help_page','restaurant')}}" help-attr="restaurants">
									{{trans('messages.help.for_restaurants')}}
								</a>
							</li>
						</ul>
					</div>
