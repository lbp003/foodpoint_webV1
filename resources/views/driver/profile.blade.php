				...
				<div class="profile-info col-12 col-md-9 col-lg-9">
					<div class="row d-block">
						...
						<div class="form-group d-md-flex">
							...
							<div class="col-md-7">
								<input type="text" name="postal_code" placeholder="{{trans('messages.profile.postal_code')}}" value="{{($driver_details->user_address)?$driver_details->user_address->postal_code:''}}" id="postal_code">
							</div>
						</div> -->
