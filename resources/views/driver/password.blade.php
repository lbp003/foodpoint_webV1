	...
	<div class="container">
		<div class="login-form py-5 mb-5 col-md-8 col-lg-6 mx-auto">
			...
			@csrf
				...
				<div class="mt-4">
					<p>
						<a href="{{route('driver.forgot_password')}}" class="theme-color">{{trans('messages.profile.forget_password')}}<span class="qust">{{ trans('messages.restaurant.ques_mark') }}</span> </a>
