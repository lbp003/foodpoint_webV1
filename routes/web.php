...
Route::group(['middleware' => ['locale','clear_cache']], function () {
...
//restaurant details
Route::match(array('GET', 'POST'), '/details/{restaurant_id}', 'EaterController@detail')->name('details');
...
Route::get('help/{page}', 'HelpController@help')->where(['page' => 'eater|restaurant|driver'])->name('help_page');

Route::get('help/{page}/{category_id}', 'HelpController@help_category')->where(['category_id' => '[0-9]+', 'page' => 'eater|restaurant|driver'])->name('help_category');

Route::get('help/{page}/{category_id}/{subcategory_id}', 'HelpController@help_subcategory')->where(['category_id' => '[0-9]+', 'page' => 'eater|restaurant|driver'])->name('help_subcategory');

Route::get('help/{page}/{category_id}/{subcategory_id}/{question_id}', 'HelpController@help_question')->where(['category_id' => '[0-9]+', 'question_id' => '[0-9]+', 'page' => 'eater|restaurant|driver'])->name('help_question');
...
Route::group(['middleware' => 'auth:web'], function () {
	...
	Route::post('remove_promo_code_data', 'EaterController@removePromoCode')->name('remove_promo_code_data');
});
