...
class CurrencyController extends Controller {
	...
	public function canDestroy($code) {
		...
		$restaurant_currency = Restaurant::where('currency_code', $code)->count();
		...
		} else if ($restaurant_currency > 0) {
			$return = ['status' => 0, 'message' => 'Sorry, Restaurant have this currency. So, Delete that Restaurant or Change that Restaurant currency.'];
