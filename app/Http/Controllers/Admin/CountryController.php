...
class CountryController extends Controller {
	...
	public function canDestroy($code, $phone_code) {
		...
		$find_restaurant = Restaurant::join('user','user.id','restaurant.user_id')->where('user.country_code', $code)->first();
		// $find_phone_restaurant = Restaurant::where('phone_country_code', $phone_code)->first();
		...
		} else if ($find_restaurant) {
			$return = ['status' => 0, 'message' => 'Sorry, Restaurant have this Country. So, Delete that Restaurant or Change that Restaurant Country.'];
