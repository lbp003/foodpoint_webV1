...
(function( $ ){
	...
	var methods = {
		...
		imageWidget: function(){
			...
			var container = $('<div/>',{'class':"tabbable tabs-left insert_msg"});
			var navTabs = $('<ul/>',
									{ class: "nav nav-tabs"
							}).append($('<li/>',
										{ class:"active"
			...
			handleFileSelect = function(evt) {
				...
				for (var i = 0, f; f = files[i]; i++) {
					...
					reader.onload = (function(imageFile){
						return function(e){
							//Render Thumnails
							var li = $('<li/>',{class:"col-xs-12 col-sm-6 col-md-4"});
							var a = $('<a/>',{
			...
			var imageListContainer = $("<div/>",{'class': 'col-xs-12 col-sm-12 col-md-12 col-lg-12 p-0'});
			var imageList = $('<ul/>',{"class":"thumbnails padding-top list-unstyled row mt-2",
										"id": 'imageList'
